...
### 🧑‍💻 Intern — **Trustable(Role - Backend Developer)**
*Developed backend and API integration for a chitfund application using Node.js.*

- Developed backend APIs and endpoints for a chit funds application using Node.js.
- Built secure and efficient backend workflows to support core app functions.
- Worked on the KYC verification module, handling data validation and integration.
- Improved system performance and collaborated with the team to deliver stable backend features.

### 🧠 Intern — **BlackPerl DFIR(Role - Security Engineer)**

- Contributed to develop **SIEM TOOL** collecting, analyzing, and managing security data from various sources across an organization's IT infrastructure in real-time.   
- Learned new concepts in cyber and also had hands-on experience to develop a real-time project.

### 🤖 Intern — **Vighna Aoress(OPC)Private Limited(Role -Early Backend developer , Later - MERN developer. )**

- Built full-stack web applications using a stack that includes Flask, MERN and MongoDB.
- My responsibilities involve developing robust backend APIs with Flask and Python, designing and implementing user interfaces with React, and managing data using a MongoDB database. 
- I am actively involved in all stages of the project, from initial design to feature implementation.

---

## 🌐 Socials:
[![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?logo=linkedin&logoColor=white)](https://linkedin.com/in/https://www.linkedin.com/in/vaishnavy-s) [![Medium](https://img.shields.io/badge/Medium-12100E?logo=medium&logoColor=white)](https://medium.com/@https://medium.com/@svvaishnavy) [![Pinterest](https://img.shields.io/badge/Pinterest-%23E60023.svg?logo=Pinterest&logoColor=white)](https://pinterest.com/https://www.pinterest.com/svvaishnavy/) [![X](https://img.shields.io/badge/X-black.svg?logo=X&logoColor=white)](https://x.com/https://x.com/Vaishu_sidhu) [![email](https://img.shields.io/badge/Email-D14836?logo=gmail&logoColor=white)](mailto:svvaishnavy@gmail.com) 
